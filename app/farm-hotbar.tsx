...
import {FARM_SLOTS,farmItemName,isSeed,type FarmItem} from '@/lib/game/farm-tools';
...
export function FarmHotbar({view:v,locked,onSelect}:{view:View;locked:boolean;onSelect:(item:FarmItem)=>void}){
