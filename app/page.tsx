...
export default function Home(){
 ...
 const launch=(tier:number,challenge:Challenge='calm')=>{setModal(null);setUserPaused(false);game.current?.expedition(tier,challenge);};
