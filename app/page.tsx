...
export default function Home(){
 ...
 const [v,setV]=useState<View>(initial),[started,setStarted]=useState(false),[modal,setModal]=useState<'kitchen'|'travel'|'help'|'hero'|'garden'|'inventory'|'build'|null>(null),[muted,setMuted]=useState(true),[userPaused,setUserPaused]=useState(false);
